...
public class BooleanExpressionTest {
  ...
  public void setup(){
    ...
    booleanExpression = new BooleanExpression(leftOperand, BooleanExpression.EQUALS, rightOperand);
    anotherBooleanExpression = new BooleanExpression(rightOperand, BooleanExpression.NOT_EQUALS, leftOperand);
  }
